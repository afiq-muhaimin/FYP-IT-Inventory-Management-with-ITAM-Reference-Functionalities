...
if(session.getAttribute("userid")== null && !usercat.equals("CAT2"))
    {
          ...
          <div class="card-body">
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    %>
                        <th scope="col">
                            <span class="badge bg-success rounded-3 fw-semibold">Enough</span>
                        </th>
                    <%
                        }
                            ...
                            <div class="card">
                                ...
                                <div class="overflow-scroll" style="max-height:300px;">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col col-md-1"><strong><h5><%=accumulate%></h5></strong></div>
                                    </div>
                                    <%
                                        }    
                                    %>
                        ...
                        <div class="row m-3">
                            <form action="ManageAssetReportingHandler" method="GET">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <input type="hidden" value="assetreporttest" name="source">
                                    <div>
