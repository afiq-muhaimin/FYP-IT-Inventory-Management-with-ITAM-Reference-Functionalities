  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        <div class="card">
          <div class="card-body">
              <a href="./AssetImage.jsp" class="btn btn-outline-primary">
                  <span><i class="ti ti-arrow-left"></i></span>
                  <span>Back</span>  
              </a>
            <h5 class="card-title fw-semibold my-4">Edit Asset Image</h5>
           
            <form action="UploadAssetImage" enctype="multipart/form-data" method="POST">
                <input type="hidden" value="${asset.assetID}" name="assetid">
                <div class="mb-3">
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Asset ID</label>
                        <p class="text">${asset.assetID}</p>
                    </div>
                    ...
                    <div class="mb-3">
                        <label for="formFile" class="form-label">Upload new image here</label>
                        <input class="form-control" type="file" id="formFile" name="assetimage" accept="image/jpeg, image/png, image/jpg" required>
                            <script>
