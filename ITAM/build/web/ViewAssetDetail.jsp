      ...
      <div class="container-fluid">
        <div class="card">
          <div class="card-body">
              ...
              <div class="mb-3">
                  <h5 class="card-title fw-semibold my-4">View Asset Detail</h5>
                ...
                <div class="mb-3">
                    ...
                    <p class="text">${asset.assetRemarks}</p>
                </div>
                <div class="mb-3">
                    <label for="exampleInputPassword1" class="form-label">Asset Origin Quantity</label>
                    <p class="text">${asset.assetOriginQty}</p>
                </div>
                <div class="mb-3">
                    <label for="exampleInputPassword1" class="form-label">Asset Type</label>
                    <div class="d-flex flex-row mb-3">
                        <p class="text">${asset.typeID}</p>
                        <c:forEach var="itemtypes" items="${listTypes}">
                            <c:if test="${asset.typeID == itemtypes.typesID}">
                                <p class="text">(${itemtypes.typesDetails})</p>
                            </c:if>
                        </c:forEach>
                    </div>
